...
const footerLinks = {
  ...
  Resources: [
    { name: "Check Eligibility", href: "/assessment" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <form className="flex w-full md:w-auto gap-1.5" onSubmit={(e) => e.preventDefault()}>
              <input type="email" placeholder="your@email.com" className="flex-1 md:w-56 px-3 py-2.5 sm:py-1.5 bg-white/5 border border-white/8 text-[13px] sm:text-[11px] text-white placeholder-white/25 focus:outline-none focus:border-white/15 font-sans rounded-none" />
              <button type="submit" className="px-4 py-2.5 sm:py-1.5 bg-white text-ink text-[12px] sm:text-[10px] font-sans font-semibold hover:bg-white/90 active:bg-white/80 transition-colors uppercase tracking-wider whitespace-nowrap">Subscribe</button>
            </form>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-serif text-white font-bold text-sm">The US Visa News</span>
            </div>
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-[9px] font-sans text-white/15 leading-relaxed space-y-2">
            <p>&copy; {new Date().getFullYear()} The US Visa News. All rights reserved.</p>
            <p>
              <strong className="text-white/25">Legal Disclaimer:</strong> The US Visa News
              ...
              The US Visa News is not affiliated with, endorsed by, or sponsored by the
